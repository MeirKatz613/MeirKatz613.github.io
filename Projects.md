...
After installing the JRE, go to the folder of the JRE-which should be under Program Files, under zulu folder-and move the folder called "zulu-16-jre", and the executable into the same folder. Don't rename the JRE, just leave it as it is, otherwise the program won't work.
